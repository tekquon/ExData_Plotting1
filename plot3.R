...
with(powerData, plot(Date, Sub_metering_1, col = "black", type="l", ylab = "Energy sub metering", xlab=""))
...
legend("topright", pch = , legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), xjust=1, col = c("black", "red", "blue"), lty=1)
